...
// export const HOST_API = process.env.REACT_APP_HOST_API_KEY || `${window.location.protocol}//${window.location.hostname}:8080`;
...
export const defaultSettings = {
  ...
  themeStretch: false,
  themeRealtimeView: "chart",
  themeTrendView: "multi",
};
